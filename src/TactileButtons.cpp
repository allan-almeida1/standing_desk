...
void TactileButtons::debounceAndTrigger(uint8_t bt_idx, bool active_state,
                                        BtcbParamInt press_cb,
                                        BtcbParamInt release_cb,
                                        BtcbParamInt short_press_cb,
                                        BtcbParamInt long_press_cb,
                                        BtcbParamInt held_cb, int param)
{
    bool current_button_state = digitalRead(m_button_pins[bt_idx]);
...
void TactileButtons::handleButtonEvent(ButtonIndex button,
                                       BtcbParamInt press_cb,
                                       BtcbParamInt release_cb,
                                       BtcbParamInt short_press_cb,
                                       BtcbParamInt long_press_cb,
...
{
    debounceAndTrigger(static_cast<uint8_t>(button), 0, press_cb, release_cb,
                       short_press_cb, long_press_cb, held_cb, param);
}